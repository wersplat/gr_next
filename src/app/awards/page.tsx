...
export const metadata: Metadata = {
  title: 'Awards Race - Global Rankings',
  description: 'Track the race for Offensive MVP, Defensive MVP, and Rookie of Tournament awards in Global Rankings tournaments.',
};
